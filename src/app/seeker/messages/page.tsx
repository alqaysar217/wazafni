  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col" dir="rtl">
      ...
      <div className="flex-1 container mx-auto px-4 py-8 max-w-6xl overflow-hidden">
        <main className="flex bg-white rounded-[50px] shadow-sm border border-primary/5 overflow-hidden h-[750px]">
          {/* Chats List */}
          <div className="w-96 border-l flex flex-col bg-muted/5">
            <div className="p-8 border-b space-y-6">
              <h2 className="text-3xl font-black text-primary tracking-tight font-headline">الرسائل</h2>
              <div className="relative">
                <Search className="absolute right-4 top-4 text-muted-foreground" size={20} />
                <Input placeholder="بحث عن شركة..." className="pr-12 rounded-2xl bg-white border-primary/5 h-14 text-md font-bold shadow-sm focus-visible:ring-primary/10" />
              </div>
            </div>
              ...
              {chats.map(chat => (
                <div key={chat.id} className={cn(
                  ...
                  <div className="relative shrink-0">
                    <Avatar className="w-16 h-16 border-4 border-white shadow-md transition-transform group-hover:scale-105">
                      <AvatarImage src={`https://picsum.photos/seed/${chat.id}/100/100`} />
                      <AvatarFallback>C</AvatarFallback>
                    </Avatar>
                    {chat.online && <div className="absolute bottom-1 left-1 w-4 h-4 bg-green-500 rounded-full border-2 border-white shadow-sm"></div>}
                  </div>
                  <div className="flex-1 min-w-0 py-1 text-right">
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <span className="text-[10px] font-black text-muted-foreground/50 uppercase tracking-widest">{chat.time}</span>
                    </div>
                    <p className={cn(
                  ...
                  {chat.unread > 0 && (
                    <div className="w-6 h-6 bg-secondary text-white text-[10px] flex items-center justify-center rounded-full font-black mt-2 shadow-sm">
                      {chat.unread}
                    </div>
                  )}
                </div>
          ...
          <div className="flex-1 flex flex-col bg-[#FBFBFE]">
            ...
            <div className="p-6 border-b bg-white/50 backdrop-blur-md flex items-center justify-between">
              <div className="flex items-center gap-5">
                ...
                <div className="text-right">
                  ...
                  <p className="text-[10px] font-black text-green-500 flex items-center gap-2">
            ...
            <div className="flex-1 p-10 overflow-y-auto space-y-8 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-fixed opacity-95">
              <div className="flex justify-center">
                <span className="bg-white/80 backdrop-blur-sm px-6 py-2 rounded-full text-[10px] font-black text-muted-foreground uppercase tracking-widest shadow-sm border border-primary/5">اليوم</span>
              </div>
              
              <div className="flex items-start gap-5">
                <Avatar className="w-10 h-10 border-2 border-white shadow-sm"><AvatarImage src="https://picsum.photos/seed/1/100/100" /></Avatar>
                <div className="bg-white p-6 rounded-[30px] rounded-tr-none shadow-sm border border-primary/5 max-w-lg text-right">
                  ...
                  <span className="text-[10px] text-muted-foreground font-black mt-3 block text-left uppercase tracking-widest">10:25 ص</span>
                </div>
              </div>

              <div className="flex items-start gap-5 flex-row-reverse">
                <Avatar className="w-10 h-10 border-2 border-white shadow-sm"><AvatarImage src="https://picsum.photos/seed/seeker/100/100" /></Avatar>
                <div className="bg-primary p-6 rounded-[30px] rounded-tl-none shadow-md text-white max-w-lg text-right">
                  ...
                  <div className="flex items-center justify-end gap-2 mt-3">
                    <span className="text-[10px] text-white/60 font-black uppercase tracking-widest">10:28 ص</span>
              ...
              <div className="flex items-start gap-5">
                ...
                <div className="bg-white p-6 rounded-[30px] rounded-tr-none shadow-sm border border-primary/5 max-w-lg text-right">
                  ...
                  <span className="text-[10px] text-muted-foreground font-black mt-3 block text-left uppercase tracking-widest">10:30 ص</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 bg-white border-t border-primary/5 backdrop-blur-md">
              <div className="flex items-center gap-5">
                <Button variant="ghost" size="icon" className="rounded-2xl h-14 w-14 shrink-0 hover:bg-primary/5 transition-colors"><Paperclip size={28} className="text-muted-foreground" /></Button>
                ...
                <Button className="h-16 w-16 rounded-3xl bg-primary shadow-lg shadow-primary/20 hover:translate-y-[-2px] transition-transform"><Send size={28} /></Button>
              </div>
            </div>
          </div>
        </main>
