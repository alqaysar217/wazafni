        ...
        <div className="w-full max-w-xl space-y-10 animate-fade-in-up">
          ...
          <Tabs defaultValue="seeker" className="w-full space-y-8">
            <TabsList className="grid w-full grid-cols-2 h-16 p-2 bg-white rounded-2xl shadow-sm border">
              <TabsTrigger value="seeker" className="rounded-xl font-bold text-lg data-[state=active]:bg-primary data-[state=active]:text-white gap-2">
                <User size={20} /> باحث عن عمل
              </TabsTrigger>
              <TabsTrigger value="employer" className="rounded-xl font-bold text-lg data-[state=active]:bg-primary data-[state=active]:text-white gap-2">
                <Building2 size={20} /> صاحب عمل (شركة)
              </TabsTrigger>
            </TabsList>
